...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument("--out", default=None, help="output path (default .bug-hunter/export/report.json)")
...
def main(argv: list[str] | None = None) -> int:
    ...
    errors = validate_export(data)
    out = Path(args.out) if args.out else (root / ".bug-hunter" / "export" / "report.json")
